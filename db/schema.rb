...
ActiveRecord::Schema.define(version: 20160711170506) do
  ...
  create_table "event_games", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "ends_at"
    t.index ["event_id", "game_id"], name: "index_event_games_on_event_id_and_game_id", unique: true, using: :btree
  ...
  create_table "event_participation", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["event_id", "gamer_id"], name: "index_event_participation_on_event_id_and_gamer_id", unique: true, using: :btree
    t.index ["event_id"], name: "index_event_participation_on_event_id", using: :btree
    t.index ["gamer_id"], name: "index_event_participation_on_gamer_id", using: :btree
  end
  ...
  create_table "events", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at",                           null: false
    t.datetime "deleted_at"
    t.index ["gamer_id"], name: "index_events_on_gamer_id", using: :btree
    t.index ["privacy"], name: "index_events_on_privacy", using: :btree
  end
